...
public:
  ...
  friend std::pair<Transducer, Alphabet> diff(const Transducer &a_,
                                              Alphabet a_Alphabet_,
                                              const Transducer &b_,
                                              const Alphabet &b_Alphabet_);

  void insert(Alphabet &Alphabet_,
  ...
  friend void diff(Transducer &diff_,
                   const std::vector<int> &a_second_Symbol_vector,
                   const Transducer &b_, const Alphabet &b_Alphabet_,
                   const std::pair<int, std::vector<int> > &b_Source_,
                   bool &a_Transition_eq_b_Transition);

  friend void diff(Transducer &diff_, const int &a_first_Symbol,
                   const Transducer &b_, const Alphabet &b_Alphabet_,
                   const std::pair<int, std::vector<int> > &b_Source_,
